    ...
    <div className="footerContainer">
      <div className="footer">
        ...
        <div className="creatorContainer">
          ...
          <a
            href="https://instagram.com/iaziznr?utm_medium=copy_link"
            target="_blank"
          >
            <div className="creator">
              <div className="creatorInsta">
          ...
          <a href="https://instagram.com/ji_peang/" target="_blank">
            <div className="creator">
              <div className="creatorInsta">
                <RiInstagramFill />
              </div>
              <span>2301883340 - Nalanda Phan Iman Santoso</span>
            </div>
          </a>
        </div>
      </div>
